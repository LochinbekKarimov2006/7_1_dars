  ...
  return (
    <div className="max-w-[1100px] mx-auto mt-[60px]">
      <div className="flex items-center justify-between">
        <div className="w-[50%]">
          <h1 className="text-[50px] max-w-[80%] font-[700] line-[1px] leading-[50px]">
            We are changing the way people shop
          </h1>
          <p className="mt-[30px] max-w-[90%]  tracking-wider">
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Tempore
            repellat explicabo enim soluta temporibus asperiores aut obcaecati
            perferendis porro nobis.
          </p>
          <NavLink to="/product" className="btn mt-[30px] btn-primary">
            OUR PRODUCT
          </NavLink>
        </div>
        <div>
      ...
      <div className="pt-12 grid gap-4 md:grid-cols-2 lg:grid-cols-3 max-w-[1100px] mx-auto mb-[20px]">
        {filteredData &&
          filteredData.map((e) => (
            <NavLink onClick={()=>{setValue(e)}} to="/toliq" key={e.id}>
              <Card
                className="mt-6 bg-base-200 w-90 flex flex-col justify-between mx-[10px]"
              >
                ...
                <div className="flex flex-col justify-between h-[60%]">
                  ...
                  <CardFooter className="pt-0">
                    <p className="my-3 text-center text-blue-600 font-[500] text-[20px]">
                      ${e.price}
                    </p>
